...
<head>
	...
	<title>SIIN - Auto - Choix de domaine</title>
...
<body>
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-blog" style="padding-top:60px!important">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-offset-2 animate-box" data-animate-effect="fadeIn">
						<a class="fh5co-entry" href="#">
							<figure>
								<img src="images/dommage.png" alt="Free Website Template, Free HTML5 Bootstrap Template" class="img-responsive">
							</figure>
							<div class="fh5co-copy text-center">
								<h3>Assurance dommages</h3>
							</div>
						</a>
					</div>
					<div class="col-md-4 animate-box" data-animate-effect="fadeIn">
						<a class="fh5co-entry" href="#">
							<figure>
								<img src="images/annie2.jpg" alt="Free Website Template, Free HTML5 Bootstrap Template" class="img-responsive">
							</figure>
							<div class="fh5co-copy text-center">
								<h3>Assurance vie</h3>
							</div>
					...
					<div class="col-md-12 text-center animate-box" data-animate-effect="fadeIn" style="margin-top:50px">
						<p>
							<a href="#" class="btn btn-primary btn-outline with-arrow">Plus d'info sur les dommaines
