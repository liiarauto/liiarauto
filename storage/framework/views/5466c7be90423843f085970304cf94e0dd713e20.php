	...
	<div id="fh5co-page">
			...
			<div class="container">
				<div class="row">
					<div class="header-inner">
						<h1>
							<a href="<?php echo e(url('/')); ?>">SII<span>N.</span>
							</a>
						</h1>
						<nav role="navigation">
							<ul>
								...
								<li>
									<a href="<?php echo e(url('domaines')); ?>">Assureurs</a>
								</li>
								<li>
		...
		<aside id="fh5co-hero" clsas="js-fullheight">
			<div class="flexslider js-fullheight">
				<ul class="slides">
					<li style="background-image: url(images/annie2.jpg);">
						<div class="container">
							<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
								<div class="fh5co-property-brief-inner">
									<div class="fh5co-box">
										<h3>
											<a href="#">Regroupement d'assureurs en C.I</a>
										</h3>
										<div class="price-status">
											<span class="price">Pendant 2 mois
												<a href="#" class="tag">Gratuit</a>
											</span>
										</div>
										<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci
											omnis hic quaerat.</p>
										<span style='color:black'>Assureurs</span>
										<p class="fh5co-property-specification">
											<span>
												<strong>35</strong> Auto</span>
											<span>
												<strong>18</strong> Habitation</span>
											<span>
												<strong>22</strong> Santé</span>
										</p>
										<p>
											<a href="<?php echo e(url('formulaire')); ?>" class="btn btn-primary">Souscrire auto</a>
										</p>
									</div>
								</div>
							</div>
					...
					<li style="background-image: url(images/Abidjan.jpg);">
						<div class="container">
							<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
								<div class="fh5co-property-brief-inner">
									<div class="fh5co-box">
					...
					<li style="background-image: url(images/enfant2.jpg);">
						<div class="container">
							<div class="col-md-12 text-center js-fullheight fh5co-property-brief slider-text">
								<div class="fh5co-property-brief-inner">
									<div class="fh5co-box">
		...
		<div class="container code">
			<div class="row">
				<div style="margin-top:50px;" class="text-center text-center fh5co-heading animate-box" data-animate-effect="fadeIn">
					<h2>Tout savoir sur le code CIMA</h2>
				...
				<div class="row">
					...
					<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
						...
						<div class="fh5co-property">
							...
							<div class="fh5co-property-innter">
								<h3>
									<a href="#">Villa In Hialeah, Dade County</a>
								</h3>
								<div class="price-status">
					...
					<div class="col-md-4 item-block animate-box" data-animate-effect="fadeIn">
						...
						<div class="fh5co-property">
							...
							<div class="fh5co-property-innter">
								<h3>
									<a href="#">401 Biscayne Boulevard, Miami</a>
								</h3>
								<div class="price-status">
		...
		<div class="fh5co-section-with-image">
			...
			<div class="fh5co-box animate-box">
				...
				<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque dicta magni amet atque doloremque velit unde adipisci
					omnis hic quaerat.</p>
				<p>
					<a href="#" class="btn btn-primary btn-outline with-arrow">Get started
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
						<blockquote>
							<p>&ldquo; She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached
					...
					<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
						<blockquote>
							<p>&ldquo; Alphabet Village and the subline of her own road, the Line Lane. Pityful a rethoric question ran over her
								cheek, then she continued her way. She had a last view back on the skyline of her hometown Bookmarksgrove, the headline
								of. &rdquo;</p>
							<p>
								<span class="fh5co-author">
									<cite>Kyle Smith</cite>
								</span>
					...
					<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
						...
						<blockquote>
							<p>&ldquo; The Big Oxmox advised her not to do so, because there were thousands of bad Commas, wild Question Marks and
								devious Semikoli, but the Little Blind Text didn’t listen. S he had a last view back on the skyline of her hometown
				...
				<div class="row">
					...
					<div class="col-md-4 text-center item-block animate-box" data-animate-effect="fadeIn">
						...
						<div class="fh5co-agent">
							...
							<h3>John Doe</h3>
							<p>Veniam laudantium rem odio quod, beatae voluptates natus animi fugiat provident voluptatibus. Debitis assumenda, possimus
								ducimus omnis.</p>
							<p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12 text-center animate-box" data-animate-effect="fadeIn">
						<p>
							<a href="#" class="btn btn-primary btn-outline with-arrow">View More Posts
								<i class="icon-arrow-right"></i>
							</a>
						</p>
					</div>
